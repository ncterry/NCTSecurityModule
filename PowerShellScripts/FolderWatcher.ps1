...
# This tested on VM 
# Monitors and spits out results of any file created or deleted recursively on the Desktop 
# Not sure about additions to names, or creation of folders.  
# This did not trigger an alert as is. For folders or name changes 
# This was running 24/7 but there was no noticeable flux on CPU 
# If transcript is set on PW, then these will be recorded. 
#  
